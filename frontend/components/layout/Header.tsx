...
import { ChevronRight, MapPin, ShoppingCart, User, Minus, Plus, Trash2 } from "lucide-react";
              ...
              <div className="flex text-cloude-gray gap-6 flex-col w-full h-full">
                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col overflow-y-scroll h-[160px] gap-2">
                      {cartItems.length === 0 ? (
                        ...
                        cartItems.map((item) => (
                          <div key={item.food._id} className="flex items-center gap-3 p-2 border-b">
                            <img 
                              src={item.food.image} 
                            ...
                            <div className="flex-1">
                              <p className="font-medium text-sm">{item.food.foodName}</p>
                              <p className="text-red-500 font-semibold">${item.food.price}</p>
                            </div>
                ...
                <div className="bg-white h-[38%] w-full flex flex-col rounded-[20px] p-4 gap-5">
                  ...
                  <div className="flex justify-between">
                    ...
                    <div className="text-[16px] font-bold">${getTotalPrice().toFixed(2)}</div>
                  </div>
                  <div className="flex justify-between">
                    <div className="text-[16px] text-muted-foreground">
                      Shipping
                  ...
                  <div className="flex justify-between">
                    ...
                    <div className="text-[16px] font-bold">${(getTotalPrice() + 0.99).toFixed(2)}</div>
                  </div>
                  <Button 
